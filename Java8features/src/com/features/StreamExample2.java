...
public class StreamExample2 {
	...
	public static void main(String[] args) {
		List<Integer> l=Arrays.asList(11,-2,34,56,78,9,34,76,7,14,3,18,3,14);
...
//		l.stream().sorted().forEach(i->System.out.println(i));
	...
	//	List<Integer> o=l.stream().filter(i->i>0).collect(Collectors.toList());
		Set<Integer> o=l.stream().collect(Collectors.toSet());
		System.out.println(new TreeSet<Integer>(o));
